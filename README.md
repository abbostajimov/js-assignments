...
## Javascript Assignments  [![Build Status](https://travis-ci.org/abbostajimov/js-assignments.svg?branch=master)](https://travis-ci.org/abbostajimov/js-assignments)
...
```
* Open https://github.com/abbostajimov/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/abbostajimov/js-assignments/builds).
